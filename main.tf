...
module "knowledge_base_bucket" {
  ...
  log_bucket_name_prefix                = "kb-1accesslog-${var.app_region}-${var.env_name}"
...
module "vpc_endpoints" {
  ...
  env_name                              = var.env_name
  app_name                              = var.app_name
  depends_on                            = [module.knowledge_base_bucket, module.roles, module.aoss, module.bedrock_knowledge_base, module.bedrock_agent]
}
...
#   depends_on                              = [module.knowledge_base_bucket, module.roles, module.aoss, module.bedrock_knowledge_base, module.bedrock_agent, module.vpc_endpoints[0]]
# }